...
VALUES(SEQ_TBL_PARENT.NEXTVAL, '장보고', 20, '경기도 남양주시', '01012341234');
...
INSERT INTO TBL_PET
(PET_ID, PET_NAME, PET_AGE, PET_SYMPTOM, PET_TYPE_CODE, PARENT_ID)
VALUES(SEQ_TBL_PET.NEXTVAL, '정지욱', 3, '폐렴', 20, 3);
