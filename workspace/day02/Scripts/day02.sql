...
CREATE TABLE TBL_TEST(
	TEST_ID NUMBER CONSTRAINT PK_TEST PRIMARY KEY,
	PET_ID NUMBER,
	CONSTRAINT FK_TEST FOREIGN KEY(PET_ID) REFERENCES TBL_PET(PET_ID)
);
...
VALUES(1, 'hds1234', '한동석', 80, '1985-01-01', 40, 'A+');
...
VALUES(2, 'jbg1234', '장보고', 80, 'M','1985-01-01', 40, 'A+');
...
-- 시퀀스 생성
CREATE SEQUENCE SEQ_TBL_PARENT;
...
(PARENT_ID, PARENT_NAME, PARENT_AGE, PARENT_ADDRESS, PARENT_MOBILE)
VALUES(SEQ_TBL_PARENT.NEXTVAL, '정지욱', 20, '경기도 남양주시', '01012341234');

-- 정보 수정
-- 두 번째 한동석을 이순신으로 변경
UPDATE TBL_PARENT
SET PARENT_NAME = '이순신'
WHERE PARENT_NAME = '장보고';
...
CREATE SEQUENCE SEQ_TBL_PET;

INSERT INTO TBL_PET
(PET_ID, PET_NAME, PET_AGE, PET_SYMPTOM, PET_TYPE_CODE)
VALUES(SEQ_TBL_PET.NEXTVAL, '뽀삐', 3, '몸살', 30);



UPDATE TBL_PARENT
SET PARENT_MOBILE = '01088889999'
WHERE PARENT_ID IN (
	SELECT PARENT_ID FROM TBL_PET
	GROUP BY PARENT_ID 
